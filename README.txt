...
Notes: 
1) Execute the queries in the CumulativeProjectQueries.sql file to populate the DB with he sample data.
...
3)There are some terms that might be unfamiliar while running the application. Below are the list of Recommendations Names accepted and their associated Measures Names seperated by commas.
